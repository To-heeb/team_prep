 ...
 <div class="content-wrapper">
      ...
      <div class="col-md-12 grid-margin">
        <div class="row">
          <div class="col-12 col-xl-8 mb-4 mb-xl-0">
            ...
            <h6 class="font-weight-normal mb-0">All PrEP🧪 facilities ready in a system<span class="text-primary">🖥️.</span></h6>
          </div>
          ...
          <div class="card-people mt-auto">
            ...
            <div class="weather-info">
              <div class="d-flex align-item-center">
                ...
                <div class="ml-auto">
                  <h2 class=" font-weight-normal">PrEP</h2>
                  <h4 class="font-weight-normal">for all</h4>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-tale">
              <div class="card-body">
                <p class="mb-4">Total Facilities</p>
                <p class="fs-30 mb-2">{{$facilityCount}}</p>
                {{-- <p>10.00% (30 days)</p> --}}
              </div>
            </div>
          </div>
          <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-dark-blue">
              <div class="card-body">
                <p class="mb-4">Total Prep Applicant</p>
                <p class="fs-30 mb-2">{{$total_prep_applicant}}</p>
                {{-- <p>22.00% (30 days)</p> --}}
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
            <div class="card card-light-blue">
              <div class="card-body">
                <p class="mb-4">Number of Administered Prep</p>
          ...
          <div class="col-md-6 stretch-card transparent">
            <div class="card card-light-danger">
              <div class="card-body">
                <p class="mb-4">Functional Facilities</p>
                <p class="fs-30 mb-2">{{$functional_facilities}}</p>
                {{-- <p>0.22% (30 days)</p> --}}
              </div>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <p class="card-title">Health Facilities with PrEP</p>
            <div class="row">
              <div class="col-12">
                <div class="table-responsive">
